...
class TextfieldPageState extends State<TextfieldToTable> {
  ...
  Future<void> _showAlert(bool isSuccess, String message) async {
    final title = isSuccess ? 'Benar' : 'Error';
    ...
    return await showDialog<void>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Row(
            children: [
              Icon(isSuccess ? Icons.check_circle : Icons.error, color: color),
  ...
  void tambahData() {
    ...
    if (nama.isEmpty || hargaString.isEmpty || jumlahString.isEmpty) {
      _showAlert(false, "Data tidak boleh kosong");
      return;
    }
    ...
    _showAlert(true, "Data berhasil disimpan");
  }
